...
class TestAPI_serverinfo(unittest.TestCase):
    def test_get_host_from_hwtag(self):
        ...
        print "****** test_serverinfo_get_host_from_hwtag: PASSED"
    ...
    def test_get_host_from_ip(self):
        ...
        print "****** test_serverinfo_get_host_from_ip: PASSED"
    ...
    def test_got_host_from_mac(self):
        ...
        self.assertEqual(result, ret)
        print "****** test_serverinfo_get_host_from_mac: PASSED"
    ...
    def test_got_host_from_hostname(self):
        ...
        self.assertEqual(result, ret)
        print "****** test_serverinfo_get_host_from_hostname: PASSED"
